...
data class TBScreeningSaveRequest(
    ...
    val fatigue: Boolean?,
    val failureToGainWeightInChildren: Boolean?,
    val decreasedActivityOrPlayfulnessInChildren: Boolean?,
    val otherSymptoms: Boolean?,
    ...
    companion object {
        fun from(cache: TBScreeningCache, beneficiaryRegID: Long, providerServiceMapID: Int, createdBy: String?): TBScreeningSaveRequest {
            return TBScreeningSaveRequest(
                ...
                chestPain = cache.chestPain,
                shortnessOfBreath = cache.shortnessOfBreath,
                fatigue = cache.fatigue,
                failureToGainWeightInChildren = cache.failureToGainWeightInChildren,
                decreasedActivityOrPlayfulnessInChildren = cache.decreasedActivityOrPlayfulnessInChildren,
                otherSymptoms = cache.otherSymptoms,
...
data class TBDiagnosticsSaveRequest(
    ...
    // Digital Chest X-Ray
    val isReferredForDigitalChestXray: Boolean?,
    val reasonForDenialChestXray: String?,
    val reasonForDenialChestXrayOther: String?,
    val isDigitalChestXrayConducted: Boolean?,
    val reasonNotConductedChestXray: String?,
    val reasonNotConductedChestXrayOther: String?,
    val digitalChestXrayResult: String?,
    // Sputum Collection
    val isReferredForSputumCollection: Boolean?,
    val reasonForDenialSputum: String?,
    val reasonForDenialSputumOther: String?,
    val sputumSubmittedAt: String?,
    // NAAT / TrueNAT
    val isTruenatConducted: Boolean?,
    val reasonNotConductedNaat: String?,
    val reasonNotConductedNaatOther: String?,
    ...
    companion object {
        fun from(cache: TBDiagnosticsCache, benRegID: Long, providerServiceMapID: Int, createdBy: String?): TBDiagnosticsSaveRequest {
            return TBDiagnosticsSaveRequest(
                ...
                isReferredForDigitalChestXray = cache.isReferredForDigitalChestXray,
                reasonForDenialChestXray = cache.reasonForDenialChestXray,
                reasonForDenialChestXrayOther = cache.reasonForDenialChestXrayOther,
                ...
                reasonNotConductedNaat = cache.reasonNotConductedNaat,
                reasonNotConductedNaatOther = cache.reasonNotConductedNaatOther,
...
data class TBScreeningDTO(
    ...
    var shortnessOfBreath: Boolean? = null,
    var fatigue: Boolean? = null,
    var failureToGainWeightInChildren: Boolean? = null,
    var decreasedActivityOrPlayfulnessInChildren: Boolean? = null,
    var otherSymptoms: Boolean? = null,
    ...
    fun toCache(): TBScreeningCache = TBScreeningCache(
        ...
        riseOfFever = riseOfFever, lossOfAppetite = lossOfAppetite,
        chestPain = chestPain, shortnessOfBreath = shortnessOfBreath, fatigue = fatigue,
        failureToGainWeightInChildren = failureToGainWeightInChildren,
        decreasedActivityOrPlayfulnessInChildren = decreasedActivityOrPlayfulnessInChildren,
        otherSymptoms = otherSymptoms, age = age,
...
data class TBDiagnosticsDTO(
    ...
    // Digital Chest X-Ray
    val isReferredForDigitalChestXray: Boolean? = null,
    val reasonForDenialChestXray: String? = null,
    val reasonForDenialChestXrayOther: String? = null,
    val isChestXRayDone: Boolean? = null,
    val reasonNotConductedChestXray: String? = null,
    val reasonNotConductedChestXrayOther: String? = null,
    val chestXRayResult: String? = null,
    // Sputum Collection
    val isSputumCollected: Boolean? = null,
    val reasonForDenialSputum: String? = null,
    val reasonForDenialSputumOther: String? = null,
    val sputumSubmittedAt: String? = null,
    // NAAT / TrueNAT
    val isNaatConducted: Boolean? = null,
    val reasonNotConductedNaat: String? = null,
    val reasonNotConductedNaatOther: String? = null,
