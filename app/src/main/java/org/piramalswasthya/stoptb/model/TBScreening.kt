...
data class TBScreeningCache(
    ...
    var referredForDigitalChestXray: Boolean? = null,
    var referredForSputumCollection: Boolean? = null,
    var sputumSampleSubmittedAt: String? = null,
    var recommendedForTruenatTest: Boolean? = null,
